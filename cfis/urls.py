...
urlpatterns = [
    ...
    path('news/create',
        views.NewsCreateView.as_view(success_url=reverse_lazy('cfis:all')), name='news_create'),
    path('news/<int:pk>/update',
        views.NewsUpdateView.as_view(success_url=reverse_lazy('cfis:all')), name='news_update'),
    path('news/<int:pk>/delete',
        views.NewsDeleteView.as_view(success_url=reverse_lazy('cfis:all')), name='news_delete'),
